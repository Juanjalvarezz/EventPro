  ...
  return (
    ...
    <div className="flex justify-center items-center">
        <div className="max-w-md w-full md:w-4/5 bg-gradient-to-r from-blue-800 to-primary-600 rounded-xl shadow-2xl overflow-hidden p-8" style={{ animation: 'slideInFromLeft 1s ease-out', margin: 0 }}>
            ...
            <button className="bg-blue-500 hover:bg-blue-700 text-secondary-50 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline animate-bounce" onClick={redirectToLogin}>
                Login
            </button>
            <button className="bg-primary-500 hover:bg-primary-700 text-secondary-50 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline animate-bounce" onClick={redirectToRegister}>
                Registro
            </button> 
